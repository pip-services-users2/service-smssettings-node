...
```javascript
{
    ...
    "dependencies": {
        ....
        "service-smssettings-node": "^1.0.0",
        ...
    }
}
```
...
var plugin = require('service-smssettings-node').SmsSettingsSenecaPlugin;
...
or by using [SmsSettingsSenecaClient](https://github.com/pip-services-users2/client-smssettings-node/NodeClientApiV1.md/#client_seneca)